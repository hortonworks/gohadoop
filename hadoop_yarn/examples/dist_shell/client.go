...
import (
	hadoop_conf "github.com/xiocode/gohadoopp/hadoop_common/conf"
	hadoop_yarn "github.com/xiocode/gohadoopp/hadoop_yarn"
	yarn_conf "github.com/xiocode/gohadoopp/hadoop_yarn/conf"
	"github.com/xiocode/gohadoopp/hadoop_yarn/yarn_client"
	"log"
	"os"
	"time"
)
...
func main() {
	...
	clc.Command = []string{"go run /Users/acmurthy/dev/go/src/github.com/xiocode/gohadoopp/hadoop_yarn/examples/dist_shell/applicationmaster.go 1>/tmp/stdout 2>/tmp/stderr"}
